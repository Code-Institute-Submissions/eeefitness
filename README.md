...
Project goals:
- To get people to enquire about becoming a gym member
- To allow the public to easily contact EEE Fitness with any questions
- To present information about EEE Fitness gym so that people understand easily what is available – location, opening hours, membership pricing and what that includes
...
- I want to be able to read testimonials about the gym
- I want to find out about the staff/trainers
- I want to find out what services are on offer
 -I want to find out how much membership to the gym will cost

If I decide I am interested I want to be able to 
- Sign up to become a member
- Easily contact the gym
...
### User Centred Design
#### 1)	Strategy plane:
The main goal of the website is to attract new members to sign up to the gym or to enquire about becoming members. The website is a Business to Consumer model aimed at a fitness conscious audience. It should include minimal, relevant, content and lots of imagery of people enjoying working out. I started the UX process by creating the User Stories above which helped me work out who the project was aimed at and what I would need to include in the website to satisfy the needs of the users.
...
- A class timetable where members can see what is available and the times of the different exercise classes and book their place in their chosen class directly from the site.
- A payment system so that people can buy their membership package immediately from the site.
- A carousel for the testimonials for the mobile viewer to reduce the amount of scrolling necessary on the home page.
...
<center><img src="documentation/eee-fitness-colour-palette.png" height="300" /></center>
