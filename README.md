...
- To present users with information about the EEE Fitness gym so that they understand what facilities and services are available there, where it is located, its opening hours, its membership packages and their respective prices.
...
- I want to find out about the gym staff/trainers.
...
- I want to see who the personal trainers are.
...
### User Centred Design
#### 1)	Strategy plane:
The main goal of the website is to attract new members to sign up to the gym or to enquire about becoming members. The website follows the Business to Consumer model and is aimed at a fitness conscious audience. It should include minimal, relevant, content and lots of imagery of people working out using state-of-the-art gym equipment. 
...
After looking at the needs of the site's users and after visiting many gym websites I grouped the features into four main pages: ‘Home’, ‘About, ‘Membership’ and ‘Contact’. 


I wanted to make sure the nav bar was always easy to view in order to help users navigate through the site, therefore I thought about creating a fixed nav, however for the mobile and tablet view I opted for the smaller, neater ‘hamburger’ icon and dropdown menu to keep the screen less cluttered.

#### 4)	Skeleton plane:

I was at this stage ready to put together wireframes. I used Balsamiq for these, creating wireframes for each page on desktop, tablet and mobile.

I aimed to make sure the main content areas were expressed in similar ways, to create consistency.  A ‘hero image’, title and motivational heading has been included at the top of each page for consistency. 
...
### Design Choices
The highest percentage of gym-going users in Ireland in 2019 were in the 25 to 34 year-old age category .  This cohort of society are mobile savvy and therefore a mobile-first approach was taken, helped by the use of the Bootstrap framework. These young professionals have disposable income and I imagine that they are looking for a professional gym that achieves results.
People in this age category are likely to be busy, working, commuting, socialising, family commitments, therefore time is a precious commodity to them. Because of this I want the site to be easy to navigate with key information intuitively located. 

#### Typography
After reading the ilovewp.com article ‘Most Used Google Fonts on Gym Websites’ I chose the most popular option of Open Sans as my main font.  For the second font I went with Google Fonts’ suggested complimentary font, Roboto, which was the third most popular font for gym websites.   

#### Icons
Icons may be used alongside the text within the site in order to help the user to understand the content at a glance. They will be taken from Font Awesome and chosen to be self explanatory.
...
<center><img src="documentation/eee-fitness-colour-palette.png" height="300" width="600" /></center>
...
- #FC7536, Orange Crayola, will be used as an accent colour throughout the site, from the logo to horizontal lines between sections, to call-to-action buttons.
- #D3D3D3, Light Grey, will be used as a background colour and text colour for certain sections in order to provide a softer contrast from preceding/subsequent sections which use the Cultured white colour. 
- Text colour throughout the site will be either Cultured, Light Grey or Space Cadet, depending on which is easier for the user to read against the assigned background colour of the element in question.

## Development
After looking at my wireframes and README.md my mentor, Reuben Ferrante suggested that I look at more efficient layout for the About page as it would result in an unpleasant user experience for the mobile user.  Taking my mentor’s advice on board I looked at either including Tabs or a Dashboard.  I also looked at including a dropdown menu from the About item with three separate pages for Services, Facilities and Classes.  Again, this seemed to require more clicks and a less pleasant experience for the user. Therefore I opted to include information about the gym staff and services on the Home page and create six main pages: Home, Facilities, Classes, Membership, Contact and Sign Up.  This structure should allow the end user to access the information that they seek with fewer clicks, hopefully leading the user toward continuing the browsing experience.
...
- Websites
  ...
  * [Font Awesome](https://fontawesome.com/). Used to source the free icons used within the site and for the favicon.
